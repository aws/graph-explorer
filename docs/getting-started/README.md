...
2. In the **Node Label** picker, select **airport** (you can type to filter the list).
3. In the **Property** picker, select **code** (you can type to filter the list).
...
2. The **Node Label** picker at the top left is pre-selected to **airport**. Use it to switch to other types like **country** or **continent** (you can type to filter the list).
