...
shows every node type. A warning button appears in the toolbar next to
"Refresh Schema". Clicking it opens a popover explaining what happened and
offers a button to retry or synchronize.
