...
- **A fully hand-rolled combobox** was built first (see git history: `e93bb8b1` shipped the hand-rolled implementation and `b55ddebf` replaced it). It re-implemented accessible combobox semantics from scratch — ARIA roles, keyboard navigation, focus management, positioning — which is exactly the kind of well-tested, easy-to-get-subtly-wrong surface a primitives library exists to own. It was replaced rather than kept.
