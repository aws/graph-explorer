...
<Badge text="string" /> <Badge text="default: /" variant="note" />

Base path used to serve the `graph-explorer` front end application. Example: `/explorer`

#### `HOST`

<Badge text="string" /> <Badge text="default: localhost" variant="note" />
...
<Badge text="boolean" /> <Badge text="default: true (Docker)" variant="note" />
...
<Badge text="number" /> <Badge text="default: 443" variant="note" />

The port to use for the HTTPS server.

#### `PROXY_SERVER_HTTP_PORT`

<Badge text="number" /> <Badge text="default: 80" variant="note" />
...
<Badge text="string" /> <Badge text="default: blocked" variant="note" />
...
<Badge text='"cloudwatch" | "default"' />
<Badge text="default: default" variant="note" />
...
<Badge text="string" />
<Badge text="default: packages/graph-explorer" variant="note" />
