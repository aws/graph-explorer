...
<Code code={neptuneDbPolicy} lang="json" title="graph-explorer-neptune-db-policy.json" />

<Code code={neptuneAnalyticsPolicy} lang="json" title="graph-explorer-neptune-analytics-policy.json" />
