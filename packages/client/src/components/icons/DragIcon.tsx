...
export const DragIcon = (props: IconBaseProps) => {
  return (
    <IconBase {...props}>
      <path
      ...
      />
      <path
        d="M11 18C11 19.1046 10.1046 20 9 20C7.89543 20 7 19.1046 7 18C7 16.8954 7.89543 16 9 16C10.1046 16 11 16.8954 11 18Z"
        fill="currentColor"
      />
      <path
