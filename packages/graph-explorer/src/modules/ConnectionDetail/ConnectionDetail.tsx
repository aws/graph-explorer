...
import { ClockIcon, DatabaseIcon, GlobeIcon, LinkIcon } from "lucide-react";
...
function LastSyncInfo({ config }: { config: ConfigurationContextProps }) {
  ...
  if (lastSyncFail) {
    // return <Chip variant="error">Synchronization Failed</Chip>;
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <InfoItemValue>
          ...
          {formatRelativeDate(lastSyncUpdate)}
        </InfoItemValue>
      </TooltipTrigger>
