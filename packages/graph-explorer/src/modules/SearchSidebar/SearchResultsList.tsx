...
import { Entity, getAllEdges, getAllVertices } from "@/core";
import { useState } from "react";
import { cn } from "@/utils";
import { createEntityKey, EntitySearchResult } from "./EntitySearchResult";

export function SearchResultsList({ results }: { results: Entity[] }) {
...
function ResultCounts({ results }: { results: Entity[] }) {
...
function AddAllToGraphButton({
  ...
  const noGraphableEntities = !vertices.length && !edges.length;
