...
import { Target, TargetWithKeyframes, Transition, Variant } from "../../../types";
...
export declare function setTarget(visualElement: VisualElement, definition: Variant, { priority }?: SetterOptions): void;
