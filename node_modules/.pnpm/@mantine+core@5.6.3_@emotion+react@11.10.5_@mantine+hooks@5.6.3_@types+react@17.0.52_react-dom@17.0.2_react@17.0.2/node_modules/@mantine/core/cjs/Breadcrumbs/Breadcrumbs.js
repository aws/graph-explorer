...
const Breadcrumbs = React.forwardRef((props, ref) => {
  const _a = styles.useComponentDefaultProps("Breadcrumbs", defaultProps, props), { className, children, separator, classNames, styles: styles$1, unstyled } = _a, others = __objRest(_a, ["className", "children", "separator", "classNames", "styles", "unstyled"]);
  const { classes, cx } = Breadcrumbs_styles['default'](null, { classNames, styles: styles$1, unstyled, name: "Breadcrumbs" });
