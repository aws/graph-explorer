...
const currentScrollDownKeyframes = styles.keyframes({
  from: {
...
const currentScrollUpKeyframes = styles.keyframes({
  from: {
    transform: "translateY(60%)",
    opacity: 0
  },
...
const oldNumberScrollUpKeyframes = styles.keyframes({
  from: {
    transform: "translateY(0%)",
    opacity: 1
  },
...
const oldNumberScrollDownKeyframes = styles.keyframes({
  from: {
    transform: "translateY(0%)",
    opacity: 1
  },
...
//# sourceMappingURL=MachineNumber.styles.js.map
