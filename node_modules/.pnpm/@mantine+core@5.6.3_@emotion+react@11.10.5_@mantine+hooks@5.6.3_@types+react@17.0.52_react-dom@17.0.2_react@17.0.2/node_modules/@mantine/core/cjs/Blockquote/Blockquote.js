...
const Blockquote = React.forwardRef((props, ref) => {
  const _a = styles.useComponentDefaultProps("Blockquote", defaultProps, props), { className, color, icon, cite, children, classNames, styles: styles$1, unstyled } = _a, others = __objRest(_a, ["className", "color", "icon", "cite", "children", "classNames", "styles", "unstyled"]);
  const { classes, cx } = Blockquote_styles['default']({ color }, { classNames, styles: styles$1, unstyled, name: "Blockquote" });
