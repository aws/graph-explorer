...
const _CardSection = React.forwardRef((_a, ref) => {
  var _b = _a, { className, withBorder = false, inheritPadding = false, unstyled } = _b, others = __objRest(_b, ["className", "withBorder", "inheritPadding", "unstyled"]);
