...
const _Card = React.forwardRef((props, ref) => {
  const _a = styles.useComponentDefaultProps("Card", defaultProps, props), { className, p, radius, children, unstyled } = _a, others = __objRest(_a, ["className", "p", "radius", "children", "unstyled"]);
  const { classes, cx } = Card_styles['default'](null, { name: "Card", unstyled });
