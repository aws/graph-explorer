...
const Affix = React.forwardRef((props, ref) => {
  const _a = styles.useComponentDefaultProps("Affix", defaultProps, props), { target, position, zIndex, sx, withinPortal } = _a, others = __objRest(_a, ["target", "position", "zIndex", "sx", "withinPortal"]);
