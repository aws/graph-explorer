...
const _NavLink = React.forwardRef((props, ref) => {
  ...
  const { classes, cx } = NavLink_styles['default']({ color, variant, noWrap, childrenOffset, alignIcon: description ? "top" : "center" }, { name: "NavLink", classNames, styles: styles$1, unstyled });
