...
const Grid = forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Grid", defaultProps, props), { gutter, children, grow, justify, align, columns, className, id, unstyled } = _a, others = __objRest(_a, ["gutter", "children", "grow", "justify", "align", "columns", "className", "id", "unstyled"]);
